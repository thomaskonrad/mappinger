/**
 * Got this from https://github.com/ubahnverleih/simple-opening-hours
 * Thanks ubahnverleih!
 * License: MIT (see https://github.com/ubahnverleih/simple-opening-hours/blob/master/LICENSE)
 */
...
export class SimpleOpeningHours {
    ...
    /**
     * Returns the opening hours of the given date as a string.
     * @param date
     */
    public getOpeningHoursOn(date: Date): string {
        ...
        for (let key in this.openingHours) {
            if (i == testday) {
                let times = this.openingHours[key];

                for (let time in times) {
                    openingHours += times[time];
                }
            }
            i++;
        }
    ...
    /**
     * Returns the opening hours of today as a string.
     */
    public getOpeningHoursToday(): string {
        return this.getOpeningHoursOn(new Date());
    }
    ...
    /**
     * Parses the input and creates openingHoursToday Object
     */
    private parse(inp) {
